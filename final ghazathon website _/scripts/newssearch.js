...
for (let i of info.data) {
    ...
    link.setAttribute("href", "../HTML/news.html");  // Use the link from the data
...
document.querySelectorAll('.video-link').forEach(link => {
    link.addEventListener('click', function (event) {
        const newsID = event.currentTarget.dataset.id;  // Get the id from data-id
        const selectedNews = info.data.find(article => article.id === newsID);
